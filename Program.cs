...
public class FountainGame
{
    ...
    public static void DisplayStartGameMessage()
    {
        ...
        Console.WriteLine("- You carry with you a bow and a quiver of arrows. You can use them to shoot monsters in the caverns but be warned: you have a limited supply.");        Console.ForegroundColor = foregroundColor;
